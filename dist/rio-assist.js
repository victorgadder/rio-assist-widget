(function(){"use strict";var ar;var x=typeof document<"u"?document.currentScript:null;/**
 * @license
 ...
 */const Ju="important",si=" !"+Ju,ai=Vt(class extends Gt{constructor(e){var t;if(super(e),e.type!==Qt.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,u)=>{const n=e[u];return n==null?t:t+`${u=u.includes("-")?u:u.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:u}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?u.removeProperty(n):u[n]=null);for(const n in t){const r=t[n];if(r!=null){this.ft.add(n);const i=typeof r=="string"&&r.endsWith(si);n.includes("-")||i?u.setProperty(n,i?r.slice(0,-11):r,i?Ju:""):u[n]=r}}return ae}}),ci=new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href;new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href;const li=new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href,di=new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href,fi=new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href,hi=new URL("data:image/png;base64,",x&&x.tagName.toUpperCase()==="SCRIPT"&&x.src||new URL("rio-assist.js",document.baseURI).href).href,en=(e,t={})=>{const u=t.variant??"drawer",n=u==="sidebar",r=n||e.showConversations;return S`
  ...
  `},pi=(e,t)=>{const u=t==="sidebar",n=u?S`
        <div
